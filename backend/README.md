...
## Project Structure
    ...
    ├── testapiautosetting_126962  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126962`
...
2. Clone this repo and `cd testapiautosetting_126962`
